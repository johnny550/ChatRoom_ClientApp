...
public class ChatRoomServiceLocator extends org.apache.axis.client.Service implements ChatRoomService {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ChatRoom.class.isAssignableFrom(serviceEndpointInterface)) {
            	ChatRoomSoapBindingStub _stub = new ChatRoomSoapBindingStub(new java.net.URL(ChatRoom_address), this);
                _stub.setPortName(getChatRoomWSDDServiceName());
                return _stub;
            }
        }
